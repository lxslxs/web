...
body {
	background-image: URL(${ctxStatic }/assets/images/back.png);
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container" style="margin-top:15%">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">超研</span>
								<span class="white" id="id-text2">Technology</span>
							</h1>
							<h4 class="light-blue" id="id-company-text">&copy;发现你的美</h4>
						</div>
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<form action="${ctx}/main/loginIn">
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" placeholder="用户名"
														id="name" name="name" /> <span id="error_name"
														class="error_1"></span> <i class="ace-icon fa fa-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control" placeholder="密码"
														id="password" name="password" /> <span
														id="error_password" class="error_2"></span> <i
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														class="ace" id="readme" name="readme" /> <span
														class="lbl">记住我</span>
													</label>
...
<![endif]-->
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document
					.write("<script src='${ctxStatic }/assets/js/jquery.mobile.custom.js'>"
							+ "<"+"/script>");
	</script>
