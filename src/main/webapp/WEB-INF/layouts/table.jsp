...
<div class="sidebar" id="sidebar">
	...
	<ul class="nav nav-list">
		<%-- <li class="active"><a href="${ctx }/security/main"> <i
						class="icon-dashboard"></i> <span class="menu-text"> 问题反馈 </span>
				</a></li> --%>

		<li class="active open"><a href="#" class="dropdown-toggle"> <i
				class="icon-desktop"></i> <span class="menu-text">东方财富网</span> <b
				class="arrow icon-angle-down"></b>
		</a>
			<ul class="submenu">
				<li class="active"><a href="${ctx }/secu/l.html"> <i
						class="icon-double-angle-right"></i> 资金流向
				</a></li>
